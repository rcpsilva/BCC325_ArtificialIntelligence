...
Estudos Dirigidos: atividades individuais práticas contendo exercícios e implementações dos métodos estudados. Serão avaliados com entrevistas ou testes durante as aulas.
...
3 provas (P1, P2, P3) de 10 pontos
Nota Final = (0.1 x P1 + 0.2 x P2 + 0.5 x P3 + 0.2 x média(ED))/10

Exame Especial: Os alunos que tiverem pelo menos 75% de frequência (mínimo para aprovação) e
média inferior a seis pontos poderão fazer o Exame Especial ou o Exame Especial Parcial. Estes
exames serão provas únicas, individuais.