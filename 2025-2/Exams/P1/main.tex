...
\item (2,0 pts) Considere o labirinto abaixo. Apresente, passo a passo, a execução da sua do algoritmo de busca em profundidade com início em $s$, posição $(0,0)$, e objetivo, $g$, em $(3,3)$. Represente a fronteira a cada iteração. Considere as células livres (branco) e bloqueios (preto). 
